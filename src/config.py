...
class Config(object):
    ...
    max_runs_dag_task_queuer = conf.getint(SECTION_NAME, "max_runs_dag_task_queuer", fallback=3)
    max_runs_dag_job_collector = conf.getint(SECTION_NAME, "max_runs_dag_job_collector", fallback=3)
